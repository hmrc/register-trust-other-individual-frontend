...
class OtherIndividualNavigator @Inject() (config: FrontendAppConfig) extends Navigator {
  ...
  override def nextPage(page: Page, draftId: String, userAnswers: ReadableUserAnswers): Call =
    routes(draftId, config)(page)(userAnswers)

  private def hubNavigation(
    draftId: String,
    ...
    case TrustHasOtherIndividualYesNoPage =>
      ua =>
        yesNoNav(
          ua = ua,
  ...
  private def simpleNavigation(draftId: String): PartialFunction[Page, ReadableUserAnswers => Call] = {
    ...
    case CountryOfNationalityPage(index)    =>
      ua => navigateAwayFromCountryOfNationalityQuestions(draftId, index, ua.isTaxable)
  ...
  private def addOtherIndividualYesNoRoute(draftId: String, config: FrontendAppConfig)(

...
class IndividualOtherIndividualNavigatorSpec extends SpecBase with ScalaCheckPropertyChecks with Generators {

  val navigator = new IndividualOtherIndividualNavigator()
  val index = 0

  "Individual otherIndividual navigator" must {
